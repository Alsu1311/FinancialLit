            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Spacer(),
                  Text(
                    'Сбережения помогают чувствовать безопасность в финансовой сфере, поэтому считается целесообразным откладывать какое-то количество денег на будущие возможные траты.     Эксперты советуют: ',
