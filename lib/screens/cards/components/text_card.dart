  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: Color.fromARGB(255, 205, 204, 249),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Spacer(),
                  Text(
                    'Финансовая безопасность  - это такие условия жизни, при которых люди готовы к потенциальным финансовым вызовам и могут с ними справится',
