            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Spacer(),
                  Text(
                    'Перед тем как подписывать кредитный договор, убедитесь что все что за что вы обязываетесь платить вам нужно. Многие платные услуги могут быть бесполезны для вас',
                    style: TextStyle(
                        fontSize: 19, //22
