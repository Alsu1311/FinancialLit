            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Spacer(),
                  Text(
                    'Российская экономическая система является многоукладной. Хотя базисом является частная собственность, в соответствии со ст. 8 Конституции также существует государственная, коллективная и корпоративная собственность.',
