...
class HomePageWidget11 extends StatefulWidget {
  const HomePageWidget11({Key key}) : super(key: key);

  @override
  _HomePageWidgetState createState() => _HomePageWidgetState();
}

class _HomePageWidgetState extends State<HomePageWidget11> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Spacer(),
                  Text(
                    '3-й уровень — полное владение финансовыми инструментами для приумножения ресурсов',
