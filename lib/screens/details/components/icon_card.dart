  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: Color.fromARGB(255, 126, 151, 129),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Spacer(),
                  Text(
                    'Финансовая грамотность - это умение использовать знания и навыки для принятия правильных решений, связанных с деньгами и достижения финансового благополучия',
                    style: TextStyle(
                        fontSize: 19, //22
